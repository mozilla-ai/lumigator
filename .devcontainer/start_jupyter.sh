...
LUMIGATOR_SERVICE_HOST="localhost" RAYCLUSTER_KUBERAY_HEAD_SVC_PORT_8265_TCP_ADDR="localhost" JUPYTERLAB_SETTINGS_DIR=/etc/lumigator/data/jupyter/ /usr/local/bin/jupyter-lab --ServerApp.token="" --ip "0.0.0.0" &
