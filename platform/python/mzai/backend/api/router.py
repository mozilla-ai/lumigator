...
from mzai.backend.api.routes import events, experiments, finetuning, health
...
api_router.include_router(finetuning.router, prefix="/datasets", tags=[Tags.DATASETS])
