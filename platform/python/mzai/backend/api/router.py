...
api_router.include_router(events.router, prefix="/event", tags=[Tags.EVENTS])
api_router.include_router(events.router, prefix="/ground_truth", tags=[Tags.GROUNDTRUTH])
