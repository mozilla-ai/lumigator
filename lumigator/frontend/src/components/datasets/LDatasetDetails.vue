<template>
  <div class="l-dataset-details">
    ...
    <div class="l-dataset-details__content">
      ...
      <div v-if="selectedDataset?.generated" class="l-dataset-details__content-item">
...
async function handleGenerateGroundTruth() {
  const inferenceStarted = await experimentStore.startGroundTruthGeneration(selectedDataset.value!)
  if (inferenceStarted) {
