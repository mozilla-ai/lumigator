...
class AutoModelConfig(EvaluatorConfig):
...
class AutoTokenizerConfig(EvaluatorConfig):
...
class DatasetConfig(EvaluatorConfig):
...
class AdapterConfig(EvaluatorConfig, extra="allow"):
