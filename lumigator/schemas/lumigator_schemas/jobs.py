...
class JobResultObject(BaseModel):
    ...
    metrics: BaseModel | None = Field(default_factory=dict)
    parameters: BaseModel | None = Field(default_factory=dict)
    artifacts: BaseModel | None = Field(default_factory=dict)
