...
{{ '[`backend/api/tags.py`](https://github.com/mozilla-ai/lumigator/blob/{}/lumigator/lumigator/backend/backend/api/tags.py)'.format(commit_id) }}
...
{{ '[`BaseRecord`](https://github.com/mozilla-ai/lumigator/blob/{}/lumigator/lumigator/backend/backend/records/base.py)'.format(commit_id) }}
