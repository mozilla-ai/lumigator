...
from backend.api.routes import datasets, experiments, health, jobs, secrets, models, workflows
...
api_router.include_router(secrets.router, prefix="/secrets", tags=[Tags.KEYS])
